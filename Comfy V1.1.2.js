...
--bonfire: url('https://media.discordapp.net/attachments/787050568107556864/822911208843378698/bonfire.gif');
...
/* User popout animation */
.headerPlaying-j0WQBV.header-2BwW8b, .headerSpotify-zpWxgT.header-2BwW8b, .headerStreaming-2FjmGz.header-2BwW8b, .headerXbox-3G-4PF.header-2BwW8b { padding-bottom: 30px;}.headerPlaying-j0WQBV.header-2BwW8b:after, .headerSpotify-zpWxgT.header-2BwW8b:after, .headerStreaming-2FjmGz.header-2BwW8b:after, .headerXbox-3G-4PF.header-2BwW8b:after { background: url('https://media.discordapp.net/attachments/787050568107556864/823059749217239040/wave.png'); background-size: 250px 20px; animation: animate 6s linear infinite !important; opacity: 1 !important;}.header-2BwW8b:after, .headerPlaying-j0WQBV:before, .headerSpotify-zpWxgT:before, .headerStreaming-2FjmGz:before, .headerXbox-3G-4PF:before { position: absolute;content: "";bottom: -1px;left: 0;width: 250px;height: 20px;z-index: -1;animation: animate2 6s linear infinite;animation-delay: 0s;opacity: 0.5;}.headerPlaying-j0WQBV:before { background: url('https://media.discordapp.net/attachments/787050568107556864/823058460253093928/wave_playing.png'); background-size: 250px 20px;}.headerSpotify-zpWxgT:before { background: url('https://media.discordapp.net/attachments/787050568107556864/823058685739270194/wave_spotify.png'); background-size: 250px 20px;}.headerStreaming-2FjmGz:before { background: url('https://media.discordapp.net/attachments/787050568107556864/823058928195469322/wave_streaming.png'); background-size: 250px 20px;}.headerXbox-3G-4PF:before { background: url('https://media.discordapp.net/attachments/787050568107556864/823059183535652884/wave_xbox.png'); background-size: 250px 20px;}@keyframes animate { 0% { background-position-x: 0;} 100% { background-position-x: 250px;}}@keyframes animate2 {0% { background-position-x: 250px; } 100% { background-position-x: 0px;}}
...
.winButtonClose-1HsbF-::after { background-image: url('https://media.discordapp.net/attachments/787050568107556864/823060505236734004/close.png'); background-size: 100%;}
.winButtonClose-1HsbF-:hover::after { background-image: url('https://cdn.discordapp.com/attachments/787050568107556864/823060608219611156/close_hover.png'); background-size: 100%;}

.winButtonMinMax-PBQ2gm:nth-child(3):after { background-color: #FAA61A; padding: 5px;}
.winButtonMinMax-PBQ2gm:nth-child(3):hover::after { background-color: #faa81ae5;}

.winButtonMinMax-PBQ2gm:last-child { color: #43B581;}
.winButtonMinMax-PBQ2gm:last-child:hover { color: #43b582e3;}
...
.customEmojiPlaceholder-37iZ_j { background-image: url("https://cdn.discordapp.com/attachments/787050568107556864/823059464546287636/emoji.png");}
...
.navList-2UtuhC #sticker-picker-tab .navButton-2gQCx-:after { background-image:url("https://media.discordapp.net/attachments/787050568107556864/823059577670074388/stickers.png");}
.navList-2UtuhC #emoji-picker-tab .navButton-2gQCx-:after { background-image:url("https://cdn.discordapp.com/attachments/787050568107556864/823059464546287636/emoji.png");}
.navList-2UtuhC .navButton-2gQCx- { width: 40px; padding: 8px;}
.navList-2UtuhC .navButton-2gQCx-.navButtonActive-1MkytQ, .emojiItem-14v6tW.emojiItemSelected-1aLkfV { background-color: #6e85d321;}
...
/* Activity cards */
.activityUserPopout-2yItg2 { border-radius: 5px; margin: 0 8px 15px 8px; padding: 10px;}
.headerPlaying-j0WQBV .activityUserPopout-2yItg2 { background: #7289DA; box-shadow: 0px 4px 0px #46599c;}
.headerSpotify-zpWxgT .activityUserPopout-2yItg2 { background: #1DB954; box-shadow: 0px 4px 0px #11923e;}
.headerStreaming-2FjmGz .activityUserPopout-2yItg2 { background: #593695; box-shadow: 0px 4px 0px #47287c;}
.headerXbox-3G-4PF .activityUserPopout-2yItg2 { background: #107C10; box-shadow: 0px 4px 0px #095509;}

/* Spotify card */
.headerSpotify-zpWxgT .buttonsWrapper-2spIeK { justify-content: space-evenly;}
.headerSpotify-zpWxgT .buttonsWrapper-2spIeK .flex-1xMQg5 { text-indent: -1000px; overflow: hidden;}
.headerSpotify-zpWxgT .buttonsWrapper-2spIeK .lookOutlined-3sRXeN.colorWhite-rEQuAQ { border: none; padding: 0; width: 32px; margin-bottom: 5px;}
.disabledButtonWrapper-3wH6-b { width: unset;}
.headerSpotify-zpWxgT .headerTextNormal-2mGWX3 { display: none;}

/* Playing card */
.headerPlaying-j0WQBV .lookOutlined-3sRXeN.colorWhite-rEQuAQ { box-shadow: 0px 3px 0px #46599c; border: 1px solid #46599c; transition: 0.15s;}
.headerPlaying-j0WQBV .lookOutlined-3sRXeN.colorWhite-rEQuAQ:hover {
    box-shadow: 0px 0px 0px 0px #46599c;
    border: 1px solid #46599c;
...
/* Playing */
.topSectionPlaying-1J5E4n .activityProfile-2bJRaP { background: #7289DA; box-shadow: 0px 4px 0px #46599c;}
.topSectionPlaying-1J5E4n .actionButton-3W1xZa { background: #46599c81 !important; backdrop-filter: blur(10px);}
.topSectionPlaying-1J5E4n .actionsProfile-jEtjVX .button-2IFFQ4 { box-shadow: 0px 3px 0px #46599c; border: 1px solid #46599c; padding: 0 5px;}
.topSectionPlaying-1J5E4n .actionsProfile-jEtjVX .button-2IFFQ4 .streamIcon-2zxjAa { width: 24px; height: 24px; margin-left: 4px;}
.topSectionPlaying-1J5E4n .bodyNormal-2D39hT .buttonsWrapper-2spIeK { flex-direction: column;}

/* Spotify */
.topSectionSpotify-1lI0-P .activityProfile-2bJRaP { background: #1DB954;  box-shadow: 0px 4px 0px #11923e;}
.topSectionSpotify-1lI0-P .actionButton-3W1xZa { background: #1db9544b !important; backdrop-filter: blur(10px);}
.topSectionSpotify-1lI0-P .actionsProfile-jEtjVX .flex-1xMQg5 { text-indent: -1000px; overflow: hidden;}
.topSectionSpotify-1lI0-P .actionsProfile-jEtjVX .button-2IFFQ4 { border: none; padding: 0; width: 25px; margin-bottom: 5px;}
.topSectionSpotify-1lI0-P .actionsProfile-jEtjVX .disabledButtonWrapper-3wH6-b { margin-bottom: 5px;}
.topSectionSpotify-1lI0-P .buttonsWrapper-2spIeK, .topSectionSpotify-1lI0-P .disabledButtonWrapper-3wH6-b { flex-direction: column;}

/* Streaming */
.topSectionStreaming-1Tpf5X .activityProfile-2bJRaP { background: #593695; box-shadow: 0px 4px 0px #47287c;}
.topSectionStreaming-1Tpf5X .button-38aScr { background: #5936954b !important; backdrop-filter: blur(10px);}
.topSectionStreaming-1Tpf5X .bodyNormal-2D39hT { flex-direction: column;}
.topSectionStreaming-1Tpf5X .bodyNormal-2D39hT * { margin: 3px; text-align: center;}

/* Xbox */
.topSectionXbox-3fWLjS .activityProfile-2bJRaP { background: #107C10; box-shadow: 0px 4px 0px #095509;}
.topSectionXbox-3fWLjS .actionButton-3W1xZa { background: #3a9d6f50 !important; backdrop-filter: blur(10px);}
...
[aria-controls="USER_INFO-tab"]:after { background-image:url("https://cdn.discordapp.com/attachments/787050568107556864/823057541881397278/user.png");}
[aria-controls="MUTUAL_GUILDS-tab"]:after { background-image: url("https://cdn.discordapp.com/attachments/787050568107556864/823057721577177098/guild.png");}
[aria-controls="MUTUAL_FRIENDS-tab"]:after { background-image:url("https://cdn.discordapp.com/attachments/787050568107556864/823057906144378890/friend.png");}
...
.topSectionNormal-2-vo2m *, .topSectionSpotify-1lI0-P *, .topSectionPlaying-1J5E4n *, .topSectionStreaming-1Tpf5X *, .body-3ND3kc { z-index: 1;}
...
/* PermisssionViewer support, thx _david_ */
...
.theme-dark .reactionSelected-1pqISm { background-color: #6e85d321; }
...
/* Comfy camp server */
[src="https://cdn.discordapp.com/icons/811203761619337259/0564a75bda132490421a8d4cccb0ea1c.webp?size=128"] { content: url('https://media.discordapp.net/attachments/787050568107556864/822911208843378698/bonfire.gif');}
.listItem-2P_4kh:hover .icon-27yU2q[src*="https://cdn.discordapp.com/icons/811203761619337259/0564a75bda132490421a8d4cccb0ea1c"] { content: url('https://media.discordapp.net/attachments/787050568107556864/822911208843378698/bonfire.gif');}
...
.winButtonClose-1HsbF-:after { padding: 6px;}
.winButtonClose-1HsbF-::after { background-image: url('https://media.discordapp.net/attachments/787050568107556864/823060505236734004/close.png'); background-size: 100%;}
.winButtonClose-1HsbF-:hover::after { background-image: url('https://media.discordapp.net/attachments/787050568107556864/823060608219611156/close_hover.png'); background-size: 100%;}
